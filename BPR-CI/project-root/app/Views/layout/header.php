<nav class="navbar navbar-expand-lg bg-light">
  <div class="container-fluid">
    <a class="navbar-brand text-dark d-flex text-truncate" href="#">
      ...
      <span class="ms-2">BPR Lestari <br>PT BPR Danapermata Lestari</span>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav ms-auto">
        ...
        <a class="btn navbar-btn text-white px-3" href="#" style="background-image: linear-gradient(to right, #0d509d, #1769c6);">Login</a>
      </div>
    </div>
  </div>
</nav>