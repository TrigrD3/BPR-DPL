    ...
    (b._ = c =
      {
        numberToFormat: function (a, c, d) {
          ...
          if (
            ...
            i
              ? (b._.includes(i, '[') ? ((i = i.replace(']', '')), (i = i.split('[')), (v = b._.toFixed(a, i[0].length + i[1].length, d, i[1].length))) : (v = b._.toFixed(a, i.length, d)),
                (h = v.split('.')[0]),
        ...
        format: function (a, c, d) {
          ...
          for (
            c = c.replace(/\s?\$\s?/, ''),
              ...
              a >= 0 ? ((i.before = i.before.replace(/[\-\(]/, '')), (i.after = i.after.replace(/[\-\)]/, ''))) : 0 > a && !b._.includes(i.before, '-') && !b._.includes(i.before, '(') && (i.before = '-' + i.before),
              g = 0;
            g < i.before.length;
            g++
          )
