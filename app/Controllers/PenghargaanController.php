...
class PenghargaanController extends BaseController
{
    public function __construct()
    {
        ...
        $this->PenghargaanModel = new \App\Models\PenghargaanModel();
    ...
    public function index()
    {
        ...
        $data['PenghargaanProduk'] = $this->PenghargaanModel->get_all_produk();
        $data['PenghargaanIklan'] = $this->PenghargaanModel->get_all_iklan();
        return view('Admin/Penghargaan/AdminPenghargaan', $data);
    }
