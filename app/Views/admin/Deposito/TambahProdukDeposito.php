        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Tambah Produk Deposito</h3>
                ...
                <div class="card-body">
                    <form action="<?= base_url('/TambahProdukDeposito') ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="inputClientCompany">Pilih Pilih Thumbnail (800x600)</label>
