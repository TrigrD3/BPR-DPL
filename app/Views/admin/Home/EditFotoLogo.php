                ...
                <div class="card-body">
                    <form action="<?= base_url('EditFotoLogo') . '/' . $foto_logo->id_foto_logo ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="inputClientCompany">Pilih Foto Logo Kredit</label>
                            <br>
                        ...
                        <div class="form-group">
                            <label for="inputClientCompany">Pilih Foto Logo Deposito</label>
                            <br>
                        ...
                        <div class="form-group">
                            <label for="inputClientCompany">Pilih Foto Logo Tabungan</label>
                            <br>
